...
let tops = [
	...
	new Top(198, 29, 46, 7048, 12.5, [255, 182, 193, "Iltheus (S3)"]),
...
let rings = [
	...
	new Ring(82, 16, 24, 3953, 27.5, [255, 182, 193, "Variable (S3)"]),
...
let drivers = [
	...
	new Driver(88, 16, 24, 3187, 10, [255, 182, 193, "Source (S3)"]),
...
function setup() {
	...
	let input1 = getPartNum(prompt("bey 1: top_ring_driver", "b7c"));
	let input2 = getPartNum(prompt("bey 2: top_ring_driver", "1ad"));
